...
public class ShopItems {
    ...
    private static ItemStack createShopItem(Material mat, int amountInStack, String name, @Nullable String... lore) {
        ...
        switch (name) {
            case "§e§lЗелья": ((PotionMeta) meta).setColor(Color.YELLOW); break;
            case "§eЛук II уровня": meta.addEnchant(Enchantment.ARROW_DAMAGE, 1, true); break;
            case "§eЛук III уровня": meta.addEnchant(Enchantment.ARROW_DAMAGE, 2, true); meta.addEnchant(Enchantment.ARROW_KNOCKBACK, 2, true); break;
            case "§eПалка": meta.addEnchant(Enchantment.KNOCKBACK, 2, true); break;
            case "§eСтрела урона": ((PotionMeta) meta).setBasePotionData(new PotionData(PotionType.INSTANT_DAMAGE)); ((PotionMeta) meta).setColor(Color.ORANGE); break;
            case "§eСтрела слабости": ((PotionMeta) meta).addCustomEffect(new PotionEffect(PotionEffectType.WEAKNESS, 5, 0, false), true); ((PotionMeta) meta).setColor(Color.PURPLE); break;
            case "§eКирка I уровня":
            case "§eТопор I уровня": meta.addEnchant(Enchantment.DIG_SPEED, 1, true); break;
            case "§eКирка II уровня":
            case "§eТопор II уровня": meta.addEnchant(Enchantment.DIG_SPEED, 2, true); break;
            case "§eКирка III уровня":
            case "§eТопор III уровня": meta.addEnchant(Enchantment.DIG_SPEED, 3, true); break;
            case "§eКирка IV уровня":
            case "§eТопор IV уровня": meta.addEnchant(Enchantment.DIG_SPEED, 4, true); break;
            case "§eКирка V уровня":
            case "§eТопор V уровня": meta.addEnchant(Enchantment.DIG_SPEED, 5, true); break;
            case "§eЗелье невидимости": ((PotionMeta) meta).addCustomEffect(new PotionEffect(PotionEffectType.INVISIBILITY, 600, 0, true), true); ((PotionMeta) meta).setColor(Color.PURPLE); break;
            case "§eЗелье прыгучести": ((PotionMeta) meta).addCustomEffect(new PotionEffect(PotionEffectType.JUMP, 900, 4, true), true); ((PotionMeta) meta).setColor(Color.LIME); break;
            case "§eЗелье скорости": ((PotionMeta) meta).addCustomEffect(new PotionEffect(PotionEffectType.SPEED, 900, 1, true), true); ((PotionMeta) meta).setColor(Color.AQUA); break;
            case "§eАрбалет I уровня": meta.addEnchant(Enchantment.ARROW_KNOCKBACK, 1, true); meta.addEnchant(Enchantment.QUICK_CHARGE, 1, true); break;
            case "§eАрбалет II уровня": meta.addEnchant(Enchantment.ARROW_KNOCKBACK, 1, true); meta.addEnchant(Enchantment.QUICK_CHARGE, 2, true); meta.addEnchant(Enchantment.MULTISHOT, 1, true); break;
        }
    ...
    public static ItemStack WOOL = ShopItems.createShopItem(Material.WHITE_WOOL, 16, "§eШерсть", "§8Стоимость: §64 бронзы", " ", "§5Отлично подходит для стройки мостов.", "§dПри покупке красится в цвет вашей команды.");
    public static ItemStack TERRACOTTA = ShopItems.createShopItem(Material.WHITE_TERRACOTTA, 16, "§eТерракота", "§8Стоимость: §616 бронзы", " ", "§5Базовый блок для защиты кровати.", "§dБыстро ломается киркой.");
    public static ItemStack LADDER = ShopItems.createShopItem(Material.LADDER, 16, "§eЛестница", "§8Стоимость: §71 железо", " ", "§5Отлично подходит для спасения", "§кошек, застрявших на дереве.", "§d:3");
    public static ItemStack GLASS = ShopItems.createShopItem(Material.GLASS, 4, "§eСтекло", "§8Стоимость: §72 железа", " ", "§5Блок для защиты кровати.", "§dВзрывоустойчивый.");
    public static ItemStack BIRCH_PLANKS = ShopItems.createShopItem(Material.BIRCH_PLANKS, 16, "§eДоски", "§8Стоимость: §74 железа", " ", "§5Блок для защиты кровати.", "§dОтлично защищает кровать", "§dот игроков без топоров.");
    public static ItemStack REDSTONE_ORE = ShopItems.createShopItem(Material.REDSTONE_ORE, 4, "§eРедстоуновая руда", "§8Стоимость: §e2 золота", " ", "§5Хороший блок для защиты", "§5кровати на начальной стадии игры.", "§dДолго ломается деревянной", "§dи каменной кирками.");
    ...
    public static ItemStack STICK = ShopItems.createShopItem(Material.STICK, 1, "§eПалка", "§8Стоимость: §68 бронзы", " ", "§5Потерянная трость", "§5Админа сервера §dKernox'a§5.");
    public static ItemStack WOODEN_SWORD = ShopItems.createShopItem(Material.WOODEN_SWORD, 1, "§eДеревянный меч", "§8Стоимость: §612 бронзы", " ", "§5Меч, лишь бы руками не сражаться.");
    public static ItemStack STONE_SWORD = ShopItems.createShopItem(Material.STONE_SWORD, 1, "§eКаменный меч", "§8Стоимость: §76 железа", " ", "§5Неплохой меч для сражений", "§5на начальной стадии игры.");
    public static ItemStack IRON_SWORD = ShopItems.createShopItem(Material.IRON_SWORD, 1, "§eЖелезный меч", "§8Стоимость: §e4 золота", " ", "§5Железный меч для тех, кто", "§5с железными... нервами!");
    ...
    public static ItemStack SHEARS = ShopItems.createShopItem(Material.SHEARS, 1, "§eНожницы ", "§8Стоимость: §74 железа", " ", "§5Хорошо ломают шерсть.", "§dВыдаётся навсегда.");
    public static ItemStack WOODEN_PICKAXE = ShopItems.createShopItem(Material.WOODEN_PICKAXE, 1, "§eКирка I уровня", "§8Стоимость: §620 бронзы", " ", "§5Уровень предмета может", "§5быть повышен.", "§5После смерти вы теряете", "§5один уровень улучшения.", "§dI уровень остается навсегда.");
    public static ItemStack STONE_PICKAXE = ShopItems.createShopItem(Material.STONE_PICKAXE, 1, "§eКирка II уровня", "§8Стоимость: §78 железа", " ", "§5Уровень предмета может", "§5быть повышен.", "§5После смерти вы теряете", "§5один уровень улучшения.");
    public static ItemStack IRON_PICKAXE = ShopItems.createShopItem(Material.IRON_PICKAXE, 1, "§eКирка III уровня", "§8Стоимость: §e6 золота", " ", "§5Уровень предмета может", "§5быть повышен.", "§5После смерти вы теряете", "§5один уровень улучшения.");
    public static ItemStack DIAMOND_PICKAXE = ShopItems.createShopItem(Material.DIAMOND_PICKAXE, 1, "§eКирка IV уровня", "§8Стоимость: §e10 золота", " ", "§5Уровень предмета может", "§5быть повышен.", "§5После смерти вы теряете", "§5один уровень улучшения.");
    ...
    public static ItemStack FISHING_ROG = ShopItems.createShopItem(Material.FISHING_ROD, 1, "§eУдочка", "§8Стоимость: §74 золота", " ", "§5Удобна для рыбалки и", "§5хороша чтобы скидывать", "§5игроков в бездну.", "§dнавсегда.");
    public static ItemStack SHIELD = ShopItems.createShopItem(Material.SHIELD, 1, "§eЩит", "§8Стоимость: §28 изумрудов", " ", "§5Отлично защищает,", "§5от стрел и мечей.");
