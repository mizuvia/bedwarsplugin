...
public class onPlayerRespawn extends SimpleListener implements Listener, EventExecutor {
    ...
    public void execute(@NotNull Listener listener, @NotNull Event event) throws EventException {
        ...
        if(this.getPlugin().isLoading()) {
            if(this.getPlugin().isLoading()) PlayerInv.setWaitingInventory(this.getPlugin().getPlayer(e.getPlayer()));
...
//
//            if (this.getPlugin().getPlayer(e.getEntity().getName()).getTeam().isBroken()) {
//                this.getPlugin().getTab().removePlayer(this.getPlugin().getPlayer(e.getEntity().getName()));
...
//                    e.getEntity().teleport(this.getPlugin().getPlayer(e.getEntity().getName()).getTeam().getSpawnLocation());
//                    PlayerInv.setPlayingInventory(this.getPlugin().getPlayer(e.getEntity().getName()));
